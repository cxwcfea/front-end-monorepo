...
// ../../node_modules/.pnpm/@ruabick+vitepress-demo-block@0.2.8/node_modules/@ruabick/vitepress-demo-block/dist/vitepress-demo-block.js
var w = (e, o) => {
...
var G = defineComponent({
  ...
  setup(e) {
    const o = e, s = "https://sfc.vuejs.org/", c = computed(() => {
      const n = {
        "App.vue": o.content
      };
      if (o.importMap)
...
var it = defineComponent({
  ...
  setup(e) {
    const o = e, { showTip: s, copyCode: c } = K(o.code), n = computed(() => decodeURIComponent(o.code)), u = computed(
